package pl.sda.javazaawansowana.pokaz.refleksja;
...
public class Main {
    ...
    public static void uzyjJakichsMetodZKlasy() throws ClassNotFoundException, InvocationTargetException, IllegalAccessException, NoSuchMethodException, InstantiationException {
        Class<?> carClass = Class.forName("pl.sda.javazaawansowana.pokaz.refleksja.Car");    // pobranie obiektu Class dla klasy Car
    ...
    public static void wyswietlMetodyKlasy() throws ClassNotFoundException {
        Class<?> carClass = Class.forName("pl.sda.javazaawansowana.pokaz.refleksja.Car");
